...
CREATE TABLE Migraciones AS
(SELECT e.tip_movi, e.tip_naci, e.anio_movi, e.mes_movi, e.dia_movi, e.sex_migr, e.nac_migr, e.subcont_nac, e.cont_nac,
       e.via_tran, e.mot_viam, e.pais_prod, e.subcont_prod, e.cont_prod, e.lug_prod, e.pais_res, e.subcont_res,
       e.cont_res, e.jef_migr, e.pro_jefm, e.can_jefm, e.cla_migr, e.ocu_migr, e.edad
FROM ESI_2019 e UNION
SELECT ei.tip_movi, ei.tip_naci, ei.anio_movi, ei.mes_movi, ei.dia_movi, ei.sex_migr, ei.nac_migr, ei.subcont_nac, ei.cont_nac,
       ei.via_tran, ei.mot_viam, ei.pais_prod, ei.subcont_prod, ei.cont_prod, ei.lug_prod, ei.pais_res, ei.subcont_res,
       ei.cont_res, ei.jef_migr, ei.pro_jefm, ei.can_jefm, ei.cla_migr, ei.ocu_migr, ei.edad
FROM ESI_2020 ei UNION
SELECT eu.tip_movi, eu.tip_naci, eu.anio_movi, eu.mes_movi, eu.dia_movi, eu.sex_migr, eu.nac_migr, eu.subcont_nac, eu.cont_nac,
       eu.via_tran, eu.mot_viam, eu.pais_prod, eu.subcont_prod, eu.cont_prod, eu.lug_prod, eu.pais_res, eu.subcont_res,
       eu.cont_res, eu.jef_migr, eu.pro_jefm, eu.can_jefm, eu.cla_migr, eu.ocu_migr, eu.edad
FROM esi_2021 eu);
...
LOAD DATA LOCAL INFILE '/Users/jonathanerazoborrero/Desktop/Universidad/ciclo 4/Proyecto Integrador/Base de Datos/2020Migracion.csv'
INTO TABLE Migracion2020
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
